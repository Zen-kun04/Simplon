...
// "La ville <insérer nom de la ville> a <insérer nombre habitant> habitants"

// Exercice #3.1
// Créer une fonction qui recevra une ville en paramètre et qui fera le console.log() que vous faite actuellement dans votre boucle
...
// Exercice #5
// Construire un tableau des villes ordonnées par leur nombre d'habitants

// ------------------------------------------------------------------------------------------------------------ //

// Exercice #6
// À l'aide d'une boucle parcourez votre tableau des villes ordonnées et créer en une liste affichable en dans le HTML (voir createElement())